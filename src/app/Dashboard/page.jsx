  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        <DrawerHeader />
        <Features />
        <div className="w-full justify-center flex flex-wrap gap-7 mt-10">
          <div className="w-full lg:w-1/2 h-96 flex-1 flex items-center bg-white rounded-xl shadow-lg">
            <Chart />
          </div>
          <div className="w-full lg:w-1/2 h-96 flex-1 flex items-center bg-white rounded-xl shadow-lg">
            <ChartAxis />
